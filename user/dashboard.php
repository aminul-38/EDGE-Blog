...
<div class="container mt-3">
  <div class="row">
    ...
    <div class="col border-start" style="min-height: 60vh">
      <h1 class="text-center my-3 text-warning-emphasis">Your Posts</h1>
      <hr />
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <?php
          $sql = "SELECT * FROM posts WHERE userID = '$_SESSION[user_id]'";
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              echo '<tr>
                          ...
                          <td>' . $row['dateTime'] . '</td>
                          <td>
                              <a class="btn btn-warning" href="edit-post.php?post_id=' . $row['postID'] . '">Edit</a>
                              <a class="btn btn-danger" href="delete-post.php?post_id=' . $row['postID'] . '">Delete</a>
                          </td>
                          </tr>';
            }
          }
