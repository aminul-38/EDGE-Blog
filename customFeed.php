...
<div class="container">
    <div class="row mt-5">
        <div class="col-md-8">
            ...
            $sql = "SELECT posts.*, category.categoryName, users.name FROM posts JOIN category ON posts.categoryID=category.categoryID 
                    JOIN users ON posts.userID = users.userID WHERE posts.categoryID = '$categoryID'";
        ...
        <div class="col-md-4 mb-5">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            $active = $row['categoryID'] == $categoryID ? "active" : "";
